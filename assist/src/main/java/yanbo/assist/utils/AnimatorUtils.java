...
public class AnimatorUtils {
     ...
     */
    public static void changeLargeViewSize(final View target, final int toWidth, final int toHeight, long duration, Interpolator interpolator) {
     ...
     * @param interpolator 时间插值器默认为DecelerateInterpolator
     */
    public static void changeViewSize(final View target, final int toWidth, final int toHeight, long duration, TimeInterpolator interpolator) {
        final ViewGroup.LayoutParams params = target.getLayoutParams();
